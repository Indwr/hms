		...
		<div class="col-lg-12">
			<div class="card m-b-30">
				<div class="card-header">
					<h5 class="card-title"><?php  echo lang('list'); ?>  <?php  echo lang('leave_app'); ?></h5>
				</div>
				<div class="card-body">
                        ...
                        <?php foreach ($leaves as $leave) { ?>
                           <tr class="">
                                ...
                                <td>
									...
									<?php if(empty($leave->status)){ ?>
									<a class="btn btn-warning btn-xs btn_width " href="leave/approve?id=<?php echo $leave->id; ?>" onclick="return confirm('Are you sure you the approve this leave application');"><i class="glyphicon glyphicon-ok-sign"></i> <?php echo lang('approve'); ?></a>
									<a class="btn btn-danger btn-xs btn_width " href="leave/decline?id=<?php echo $leave->id; ?>" onclick="return confirm('Are you sure you the decline this leave application');"><i class="fa fa-times"></i> <?php echo lang('decline'); ?></a>
