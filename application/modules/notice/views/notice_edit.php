		...
		<div class="col-lg-9">
			<div class="card m-b-30">
				<div class="card-header">
					<h5 class="card-title">
				<?php echo lang('edit');?> <?php echo lang('notice');?></h5>
				</div>
				<div class="card-body">
                ...
                <form role="form" action="notice/addNew" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" id="exampleInputEmail1" value='<?php echo $notice->title; ?>' placeholder="" required>
                    </div>
                    </div>
				    <div class="col-md-3">
                    <div class="form-group">
                        <label for="exampleInputEmail1"> <?php  echo lang('from_date'); ?></label>
                        <input type="text" class="form-control default-date-picker" name="from_date" id="exampleInputEmail1" value='<?php echo $notice->from_date; ?>' placeholder="" required>
                    </div>
                    </div>
				    <div class="col-md-3">
                    <div class="form-group">
                        <label for="exampleInputEmail1"> <?php  echo lang('to_date'); ?></label>
                        <input type="text" class="form-control default-date-picker" name="to_date" id="exampleInputEmail1" value='<?php echo $notice->to_date; ?>' placeholder="" required>
                    </div>
                    </div>
                    </div>
					...
					<textarea  class="ckeditor form-control editor" name="description" cols="52" id="" rows="6" placeholder=""><?php echo $notice->description; ?></textarea>						                  
				   </div>
					...
					<input type='checkbox' value="Doctor" name="user[]"
					   <?php
					   if (!empty($notice->id)) {
						   $user_seen = $this->notice_model->getNoticeById($notice->id)->user;
