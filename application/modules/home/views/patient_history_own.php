...
<div class="contentbar">
                   ...
                   <table class="table table-striped table-hover table-bordered" id="bateristaworks">
						<thead>
							<tr>                     
								...
								<?php if (in_array('medical_history', $permission1) || $this->ion_auth->in_group(array('admin')) || $this->ion_auth->in_group(array('Patient'))) { ?>
						...
						?>
							<tr class="">
								...
								<td>
								 ...
								 <button type="button" class="btn btn-primary btn-xs btn_width rxx" data-toggle="modal" data-id="<?php echo $medical_history->id; ?>"><i class="fa fa-eye"></i> Rx</button>  
		...
		<div class="col-lg-12 col-xl-12 " id="appoint_head">
				<div class="card m-b-30 dash-widget">
					<div class="card-header">                                
						<div class="row align-items-center">
							<div class="col-12">
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-eye"></i> View Medical Findings</h4>
            </div>
            <div class="modal-body">
                <form role="form" id="editMedicalHxForm"  method="post" enctype="multipart/form-data">
				
					<div class="row">
					<div class="col-md-8">
					<div class="form-group">
					<label for="exampleInputEmail1">  <?php echo lang('date'); ?>  </label>
					<input  type="text" class="form-control  default-date-picker" name="date" value="" disabled autocomplete="off"  placeholder="" required>							                  
					</div>
					</div>
					</div>
					<!--
					...
					<textarea  class="" name="case_history" value="" cols="52" id="" rows="" disabled placeholder=""></textarea>						                  
				   </div>
				   </div>
				   </div>
				   <hr>
				   ...
				   <div class="row">
					...
					<textarea  class="" name="exam_find" value="" cols="52" id="" disabled rows="" placeholder=""></textarea>						                  
				   </div>
				   </div>
				   </div>
				   <hr>
				   ...
				   <div class="row">
					...
					<textarea  class="" name="dx" value="" cols="52" id="" rows="" disabled placeholder=""></textarea>						                  
				   </div>
				   </div>
				   </div>
...
<div class="modal fade" id="rxModalHistory" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title"><i class="fa fa-eye"></i> View Prescription</h4>
            </div>
            <div class="modal-body">
                <form role="form" id="rxModalHistory" method="post" enctype="multipart/form-data">
				<div class="row">
					<div class="col-md-12">
					<div class="form-group">
					<label for="exampleInputEmail1"><?php echo 'Prescription'; ?></label>
					<textarea  class="" name="rx" value="" cols="52" id="" rows="" placeholder="" disabled></textarea>						                  
				   </div>
				   </div>
				   </div>
                    <input type="hidden" name="patient" value="<?php echo $patient->id; ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
            ...
            <div class="modal-body">
                <form role="form" action="appointment/addNewByPatientOwn" method="post" enctype="multipart/form-data">
					<div class="form-group">
...
<div class="modal fade" id="myModalDocument" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body"><form role="form" action="patient/addPatientDocumentByPatient" method="post" enctype="multipart/form-data">
