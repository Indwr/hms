		...
		<div class="col-lg-12">
			<div class="card m-b-30">
				<div class="card-header">
					<h5 class="card-title"> Pharmacy Point Of Sales</h5>
				</div>
				<div class="card-body">
				
							<form role="form" id="editPaymentForm" class="clearfix" action="pharmacy/addPayment" method="post" enctype="multipart/form-data">

								<div class="row">
								<div class="col-md-5">
										<div class="form-group"> 
                                            <label for="exampleInputEmail1"> Select Patient </label>
											<select   class="m-bot15 js-example-basic-single"  id="pos_select" name="patient" value='' > 
                                            ...
                                            <label for="exampleInputEmail1"> Select Medicine </label>
												...
												if(!empty($category->e_date) && strtotime($category->e_date) > time() &&  ($category->howmany) > 0 && empty($category->deletii)){
															?>
											...
											<div class="form-group">
										        <label for="exampleInputEmail1"><?php echo lang('payment_mode'); ?> </label>
													<select type="text" class="form-control payment_font_weight" name="payment_mode" required>
													  ...
													  <option class="form-control "  value="POS" >POS</option>
													  <option class="form-control "  value="Bank Transfer" >Bank Transfer</option>
													</select>
                                            </div>
        ...
        $.each($('select.multi-select option:selected'), function () {
            ...
            if ($('#idinput-' + idd).length)
            {
                ...
                if ($('#id-div' + idd).length)
                {
                    ...
                    $("#editPaymentForm .qfloww").append('<div class="remove1" id="id-div' + idd + '">  ' + $(this).data("cat_name") + '- <?php echo $settings->currency; ?> ' + $(this).data('id') + '<div class="current_stock pos_element">Current Stock: ' + $(this).data('cs') + '<div class="company pos_element">Company: ' + $(this).data('cc') + '</div></div></div><div class="pos_element"><div></div>')
                }
            ...
            $.each($('select.multi-select option:selected'), function () {
                ...
                if ($('#idinput-' + idd).length)
                {
                    ...
                    if ($('#id-div' + idd).length)
                    {
                        ...
                        $("#editPaymentForm .qfloww").append('<div class="remove1" id="id-div' + idd + '">  ' + $(this).data("cat_name") + '- <?php echo $settings->currency; ?> ' + $(this).data('id') + '<div class="current_stock pos_element">Current Stock: ' + $(this).data('cs') + '<div class="company pos_element">Company: ' + $(this).data('cc') +'</div></div><div class="quantity pos_element"><div></div>')
                    }
