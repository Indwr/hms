		...
		<div class="col-lg-12">
			<div class="card m-b-30">
				<div class="card-header">
					<h5 class="card-title"><?php  echo lang('list'); ?> <?php  echo lang('my'); ?> <?php  echo lang('patient'); ?></h5>
				</div>
				<div class="card-body">
				<section id="main-content">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="bateristaworks">
						...
						$stafff = $this->db->get_where('staff', array('ion_user_id' => $staff_ion_id))->row()->id;
						if($stafff === $patient->doctor) {
						?>
                            <tr class="">
                                <td> 
